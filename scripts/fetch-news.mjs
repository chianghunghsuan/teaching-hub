...
async function summarizeOne(candidate) {
  const sys = [
    ...
    "content 用繁體中文，依序分成 6 段，每段格式一定要是『標籤：內容』——標籤後面直接接一個全形冒號『：』，絕對不要用【】、##、粗體或其他符號把標籤括起來。標籤依序固定為：摘要、課堂解釋、關鍵數據、延伸整合、反思結論、延伸討論。",
    "老師口吻，開場用一句話勾起興趣；關鍵數據每點用「- 」開頭並判讀數字（這算多嗎、代表什麼）；延伸討論每點用『問題？→ 參考方向：…（可查：真實來源）』。除了段落標籤，內文句子不要以冒號開頭。",
    '只輸出 JSON：{"tag":"社會","content":"摘要：...\\n\\n課堂解釋：...\\n\\n關鍵數據：\\n- ...\\n\\n延伸整合：...\\n\\n反思結論：...\\n\\n延伸討論：\\n- ..."}；tag 固定用「社會」。',
  ].join("\n");
